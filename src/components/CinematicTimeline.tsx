    ...
    <div ref={containerRef} className={`relative min-h-screen ${className}`}>
      ...
      <div className="relative z-10 container mx-auto px-6 py-12">
        ...
        <div className="text-center mb-6 px-4">
          <h2 className="font-playfair text-4xl md:text-5xl lg:text-7xl font-bold text-evergreen-800 mb-4 leading-tight">
            Our Journey Through Time
          </h2>
          <p className="text-lg md:text-xl lg:text-2xl text-evergreen-600 font-inter max-w-4xl mx-auto leading-relaxed">
        ...
        <div className="relative max-w-6xl mx-auto">
          {/* Progress Line */}
          <div className="absolute left-4 md:left-1/2 transform md:-translate-x-1/2 w-1 h-full bg-evergreen-200/30 z-0">
            <motion.div
              ref={progressRef}
          ...
          <div className="space-y-20">
            {events.map((event, index) => (
              <div
                key={event.year}
                className={`timeline-event timeline-event-${index} relative flex flex-col md:flex-row items-start md:items-center ${
              ...
              >
                {/* Timeline Dot */}
                <div
                  className={`absolute left-4 md:left-1/2 transform -translate-x-1/2 w-6 h-6 md:w-8 md:h-8 rounded-full border-4 border-cream-50 z-30 transition-all duration-500 ${
                    activeIndex >= index 
                ...
                {/* Content Container */}
                <div className={`w-full md:w-5/12 pl-12 md:pl-0 ${index % 2 === 0 ? 'md:pr-16 md:text-right' : 'md:pl-16 md:text-left'}`}>
                  {/* Year Badge */}
                  <div
                    className={`inline-block bg-evergreen-800 text-cream-50 px-6 md:px-8 py-2 md:py-3 rounded-full font-playfair font-bold text-xl md:text-2xl mb-6 shadow-lg ${
                  ...
                  <div className="clear-both">
                    {/* Image */}
                    <div
                      className="relative mb-8 rounded-2xl md:rounded-3xl overflow-hidden shadow-2xl group-hover:shadow-3xl hover:scale-105 transition-all duration-500"
                    >
                    ...
                    {/* Title */}
                    <h3
                      className="font-playfair text-3xl md:text-4xl lg:text-5xl font-bold text-evergreen-800 mb-4 md:mb-6 leading-tight hover:scale-105 transition-transform duration-200"
                    >
                      {event.title}
                    </h3>

                    {/* Description */}
                    <p className="text-lg md:text-xl text-evergreen-700 font-inter leading-relaxed mb-6 md:mb-8">
                      {event.description}
                    </p>
                    ...
                    {event.quote && (
                      <motion.blockquote
                        className="border-l-4 border-pink-400 pl-6 md:pl-8 py-4 md:py-6 bg-pink-50/80 rounded-r-2xl backdrop-blur-sm"
                        initial={{ opacity: 0, x: index % 2 === 0 ? 20 : -20 }}
                        whileInView={{ opacity: 1, x: 0 }}
                        transition={{ duration: 0.6, delay: 0.2 }}
                        viewport={{ once: true }}
                      >
                        <p className="text-evergreen-800 font-cormorant text-xl md:text-2xl italic leading-relaxed">
                          &quot;{event.quote}&quot;
                        </p>
                      </motion.blockquote>
                    )}
                ...
                <div className={`w-full md:w-6/12 pl-12 md:pl-0 mt-8 md:mt-0 ${index % 2 === 0 ? 'md:pl-40' : 'md:pr-40'}`}>
                  {index === 0 ? (
          ...
          {/* Timeline End */}
          <motion.div
            className="relative text-center py-12 md:py-20 pl-12 md:pl-0"
            initial={{ opacity: 0, scale: 0.8 }}
            whileInView={{ opacity: 1, scale: 1 }}
            transition={{ duration: 0.8 }}
            viewport={{ once: false }}
          >
            <div className="flex justify-center absolute top-0 left-4 md:left-0 md:right-0 z-10">
              <motion.div 
                className="w-10 h-10 md:w-12 md:h-12 bg-pink-400 rounded-full border-6 border-cream-50"
              animate={{ 
                scale: [1, 1.2, 1],
                boxShadow: [
            ...
            <div className="pt-12 md:pt-16">
              <h3 className="font-playfair text-3xl md:text-4xl font-bold text-evergreen-800 mb-3 md:mb-4">
                The Story Continues...
              </h3>
              <p className="text-lg md:text-xl text-evergreen-600 font-inter px-4">
